...
import {  XCircle, Loader2, Search, SearchIcon, XIcon ,User,Phone,BadgeIndianRupee,Calendar,Clock,CheckCircle} from "lucide-react";
...
const ServiceAppointmentsPage = () =>{
 ...
 const finalDate = a.rescheduledTo?.date || a.date || "";

let finalTime = "";

if (a.rescheduledTo?.time) {
  finalTime = a.rescheduledTo.time;
} 
else if (a.time) {
  finalTime = a.time;
} 
else if (a.hour !== undefined) {
  finalTime = `${formatTwo(a.hour)}:${formatTwo(a.minute ?? 0)} ${a.ampm || "AM"}`;
}
  ...
  return {
    ...
    rescheduledTo: a.rescheduledTo || null,
        ...
        <div className={serviceAppointmentsStyles.container}>
            ...
            {loading ? (
                ...
                <div className={serviceAppointmentsStyles.gridContainer}>
                    {displayList.length === 0 ? (<div className={serviceAppointmentsStyles.noResultsContainer}>
                        <div className={serviceAppointmentsStyles.noResultsIcon}>
                            <SearchIcon/>
                            </div>
                            <div className={serviceAppointmentsStyles.noResultsText}>
                                No Appointmnets match your search
                            </div>
