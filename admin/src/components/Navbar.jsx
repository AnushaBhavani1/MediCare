...
// Import icons (assuming you are using lucide-react)
import {
  Home,
  UserPlus,
  Users,
...
/>
            <Link to="/">
              <div className={ns.logoLink}>ShivaRaksha MediCare</div>
              <div className={ns.logoSubtext}>HealthCare Solutions - Your wellness, our sacred mission.</div>
            </Link>
          </div>
