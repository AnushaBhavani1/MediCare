...
function normalizeAppointment(a) {
 ...
 let patientImage =
  (a.userId && (a.userId.image || a.userId.imageUrl)) ||
  (a.patientId && (a.patientId.image || a.patientId.imageUrl)) ||
  a.patientImage ||
  a.image ||
  "";
  
if (patientImage && !patientImage.startsWith("http")) {
  patientImage = `${API_BASE}/${patientImage}`;
}
  const speciality =
