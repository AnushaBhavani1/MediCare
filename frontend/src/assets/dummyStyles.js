...
export const bannerStyles = {
 ...
 mainContainer:
  "relative rounded-3xl shadow-2xl overflow-hidden group min-h-[260px] bg-white",
...
export const navbarStyles = {
  ...
  navItemsContainer: "flex items-center gap-6 bg-white border border-emerald-200 p-2 rounded-full shadow-lg",
...
export const testimonialStyles = {
  ...
  // Scroll container
  scrollContainer:
"h-56 sm:h-72 md:h-[360px] lg:h-[400px] overflow-hidden no-scrollbar p-3 sm:p-4",
